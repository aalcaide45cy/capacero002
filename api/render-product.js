...
export default async function handler(req, res) {
    try {
        ...
        const cleanUrl = `https://www.capacero3d.com/producto/${productId}`;
        ...
        if (product.image && product.image.length > 0) {
            const imgUrl = product.image[0].startsWith('http') ? product.image[0] : `https://www.capacero3d.com${product.image[0]}`;
